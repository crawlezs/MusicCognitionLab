...
```{r}
#create boxplots
bxp_ryff <- ggboxplot(outcomedata, x = "event", y = "ryff", add = "point")
bxp_ryff

bxp_pss <- ggboxplot(outcomedata, x = "event", y = "pss", add = "point")
bxp_pss

bxp_bdi <- ggboxplot(outcomedata, x = "event", y = "bdi", add = "point")
bxp_bdi

bxp_bai <- ggboxplot(outcomedata, x = "event", y = "bai", add = "point")
bxp_bai

bxp_mi <- ggboxplot(outcomedata, x = "event", y = "fmqi", add = "point")
bxp_mi

bxp_cerq <- ggboxplot(outcomedata, x = "event", y = "cerq", add = "point")
bxp_cerq
```
```{r}
#create qq plots
qq_ryff <- ggqqplot(outcomedata, "ryff", facet.by = "event")
qq_ryff
qq_pss <- ggqqplot(outcomedata, "pss", facet.by = "event")
qq_pss
qq_bdi <- ggqqplot(outcomedata, "bdi", facet.by = "event")
qq_bdi
qq_bai <- ggqqplot(outcomedata, "bai", facet.by = "event")
qq_bai
qq_mi <- ggqqplot(outcomedata, "fmqi", facet.by = "event")
qq_mi
qq_cerq <- ggqqplot(outcomedata, "cerq", facet.by = "event")
qq_cerq
```
```{r}
#check for outliers
...
eta_squared(ryff_mm, partial = FALSE)
```
...
eta_squared(pss_mm, partial = FALSE)
```
...
eta_squared(bdi_mm, partial = FALSE)
```
...
eta_squared(bai_mm, partial = FALSE)
```
...
eta_squared(mi_mm, partial = FALSE)
```
...
eta_squared(cerq_mm, partial = FALSE)
```
...
eta_squared(lmm_pos, partial=FALSE)
```
...
eta_squared(lmm_neg, partial=FALSE)
```
...
eta_squared(lmm_ios, partial=FALSE)
```
#### Plots
```{r}
