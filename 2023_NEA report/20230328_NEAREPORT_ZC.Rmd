...
```{r}
#ryff reliability
reliability_ryff <- reliability[,c("group", "rwbs_1", "rwbs_2", "rwbs_3", "rwbs_4", "rwbs_5", "rwbs_6", "rwbs_7", "rwbs_8","rwbs_9", "rwbs_10", "rwbs_11", "rwbs_12", "rwbs_13", "rwbs_14", "rwbs_15", "rwbs_16", "rwbs_17", "rwbs_18")]

reliability_ryff0 <- filter(reliability_ryff, group == "0")
reliability_ryff1 <- filter(reliability_ryff, group == "1")

reliability_ryff0[,-1]
reliability_ryff1[,-1]

alpha(reliability_ryff0)
alpha(reliability_ryff1)
```
```{r}
#pss reliability
reliability_pss <- reliability[,c("group", "pss_1", "pss_2", "pss_3", "pss_4", "pss_5", "pss_6", "pss_7", "pss_8", "pss_9", "pss_10")]

reliability_pss0 <- filter(reliability_pss, group == "0")
reliability_pss1 <- filter(reliability_pss, group == "1")

reliability_pss0[,-1]
reliability_pss1[,-1]

alpha(reliability_pss0)
alpha(reliability_pss1)
```
```{r}
#bdi reliability
reliability_bdi <- reliability[,c("group", "bdi_self1", "bdi_self2", "bdi_self3", "bdi_self4", "bdi_self5", "bdi_self6", "bdi_self7", "bdi_self8", "bdi_self10", "bdi_self11", "bdi_self12", "bdi_self13", "bdi_self14", "bdi_self15", "bdi_self16", "bdi_self17", "bdi_self18", "bdi_self19", "bdi_self20", "bdi_self21")]

reliability_bdi0 <- filter(reliability_bdi, group == "0")
reliability_bdi1 <- filter(reliability_bdi, group == "1")
...
```{r}
#bai reliability
reliability_bai <- reliability[,c("group", "beckself1", "beckself2", "beckself3", "beckself4", "beckself5", "beckself6", "beckself7", "beckself8", "beckself9", "beckself10", "beckself11", "beckself12", "beckself13", "beckself14", "beckself15", "beckself16", "beckself17", "beckself18", "beckself19", "beckself20", "beckself21")]

reliability_bai0 <- filter(reliability_bai, group == "0")
reliability_bai1 <- filter(reliability_bai, group == "1")
...
```{r}
#mi reliability
reliability_mi <- reliability[,c("group", "fmi_q1", "fmi_q2", "fmi_q3", "fmi_q4", "fmi_q5", "fmi_q6", "fmi_q7", "fmi_q8", "fmi_q9", "fmi_q10", "fmi_q11", "fmi_q12", "fmi_q13", "fmi_q14")]

reliability_mi0 <- filter(reliability_mi, group == "0")
reliability_mi1 <- filter(reliability_mi, group == "1")

reliability_mi0[,-1]
reliability_mi1[,-1]

alpha(reliability_mi0)
alpha(reliability_mi1)
```
...
lme.dscore(ryff_mm, data=outcomedata, type="lme4")
```
...
eta_squared(lmm_pospre, partial = FALSE)
```
...
eta_squared(lmm_negpre01, partial=FALSE)
```
