...
```{r}
#create qq plots
ggqqplot(ema_mean2, "pos", facet.by = "group")
ggqqplot(ema_mean2, "neg", facet.by = "group")
```
...
skewness(ema_mean2$pos)
skewness(ema_mean2$neg)

kurtosis(ema_mean2$pos)
kurtosis(ema_mean2$neg)
```
