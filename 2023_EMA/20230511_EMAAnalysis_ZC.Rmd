...
```{r}
#SD Positive
stddevpos2_model1 <- lmer(stddev_pos ~ 1 + day + (1|id), data = affectdynamics_day)
anova(stddevpos2_nullmodel, stddevpos2_model1)
```
decreased model fit
```{r}
#SD Positive
stddevpos2_model2 <- lmer(stddev_pos ~ 1 + day + group + (1|id), data = affectdynamics_day)
anova(stddevpos2_model1, stddevpos2_model2)
```
decreased model fit
```{r}
#SD Positive
stddevpos2_model3 <- lmer(stddev_pos ~ 1 + day + group + weekend + (1|id), data = affectdynamics_day)
anova(stddevpos2_model2, stddevpos2_model3)
```
decreased model fit

```{r}
#SD Positive
stddevpos2_model4 <- lmer(stddev_pos ~ 1 + day + group + day*group + (1|id), data = affectdynamics_day)
anova(stddevpos2_model2, stddevpos2_model4)
```
decreased model fit

```{r}
summary(stddevpos2_model4)
```
...
```{r}
#SD Negative
stddevneg2_model1 <- lmer(stddev_neg ~ 1 + day + (1|id), data = affectdynamics_day)
anova(stddevneg2_nullmodel, stddevneg2_model1)
```
sig. increase in model fit
```{r}
#SD Negative
stddevneg2_model2 <- lmer(stddev_neg ~ 1 + day + group + (1|id), data = affectdynamics_day)
anova(stddevneg2_model1, stddevneg2_model2)
```
decrease in model fit
```{r}
#SD Negative
stddevneg2_model3 <- lmer(stddev_neg ~ 1 + day + group + weekend + (1|id), data = affectdynamics_day)
anova(stddevneg2_model2, stddevneg2_model3)
```
decrease in model fit
```{r}
#SD Negative
stddevneg2_model4 <- lmer(stddev_neg ~ 1 + day + group + day*group + (1|id), data = affectdynamics_day)
anova(stddevneg2_model2, stddevneg2_model4)
```
decrease in model fit
```{r}
summary(stddevneg2_model4)
```
...
```{r}
#MSSD Positive
mssdpos2_model1 <- lmer(mssd_pos ~ 1 + day + (1|id), data = affectdynamics_day)
anova(mssdpos2_nullmodel, mssdpos2_model1)
```
decrease in model fit
```{r}
#MSSD Positive
mssdpos2_model2 <- lmer(mssd_pos ~ 1 + day + group + (1|id), data = affectdynamics_day)
anova(mssdpos2_model1, mssdpos2_model2)
```
decrease in model fit
```{r}
#MSSD Positive
mssdpos2_model3 <- lmer(mssd_pos ~ 1 + day + group + weekend + (1|id), data = affectdynamics_day)
anova(mssdpos2_model2, mssdpos2_model3)
```
sig. increase in model fit
```{r}
#MSSD Positive
mssdpos2_model4 <- lmer(mssd_pos ~ 1 + day + group + weekend + day*group + (1|id), data = affectdynamics_day)
anova(mssdpos2_model3, mssdpos2_model4)
```
decrease in model fit
```{r}
summary(mssdpos2_model4)
```
...
```{r}
#MSSD Negative
mssdneg2_model1 <- lmer(mssd_neg ~ 1 + day + (1|id), data = affectdynamics_day)
anova(mssdneg2_nullmodel, mssdneg2_model1)
```
decrease in model fit
```{r}
#MSSD Negative
mssdneg2_model2 <- lmer(mssd_neg ~ 1 + day + group + (1|id), data = affectdynamics_day)
anova(mssdneg2_model1, mssdneg2_model2)
```
decrease in model fit
```{r}
#MSSD Negative
mssdneg2_model3 <- lmer(mssd_neg ~ 1 + day + group + weekend + (1|id), data = affectdynamics_day)
anova(mssdneg2_model2, mssdneg2_model3)
```
sig. increase in model fit

```{r}
#MSSD Negative
mssdneg2_model4 <- lmer(mssd_neg ~ 1 + day + group + day*group + (1|id), data = affectdynamics_day)
anova(mssdneg2_model2, mssdneg2_model4)
anova(mssdneg2_nullmodel, mssdneg2_model4)
```
decrease in model fit
```{r}
summary(mssdneg2_model4)
```
...
```{r}
#SD Positive
mssdpos3_model1 <- lmer(positive_SD ~ 1 + instance + (1|id), data=withinday)
anova(mssdpos3_nullmodel, mssdpos3_model1)
```
```{r}
#SD Positive
mssdpos3_model2 <- lmer(positive_SD ~ 1 + instance + day + (1|id), data=withinday)
anova(mssdpos3_model1, mssdpos3_model2)
```
```{r}
#SD Positive
mssdpos3_model3 <- lmer(positive_SD ~ 1 + instance + weekend + (1|id), data=withinday)
anova(mssdpos3_model1, mssdpos3_model3)
```
```{r}
#SD Positive
mssdpos3_model4 <- lmer(positive_SD ~ 1 + instance + event + (1|id), data=withinday)
anova(mssdpos3_model1, mssdpos3_model4)
```
```{r}
#SD Positive
mssdpos3_model5 <- lmer(positive_SD ~ 1 + instance + enrollmentgroup + (1|id), data=withinday)
anova(mssdpos3_model1, mssdpos3_model5)
```
```{r}
#SD Positive
mssdpos3_model6 <- lmer(positive_SD ~ 1 + instance + enrollmentgroup*event + (1|id), data=withinday)
anova(mssdpos3_model1, mssdpos3_model6)
```
```{r}
summary(mssdpos3_model6)
```
...
```{r}
mssdneg3_model1 <- lmer(negative_SD ~ 1 + instance + (1|id), data=withinday)
anova(mssdneg3_nullmodel, mssdneg3_model1)
```
```{r}
mssdneg3_model2 <- lmer(negative_SD ~ 1 + instance + day + (1|id), data=withinday)
anova(mssdneg3_model1, mssdneg3_model2)
```
```{r}
mssdneg3_model3 <- lmer(negative_SD ~ 1 + instance + weekend + (1|id), data=withinday)
anova(mssdneg3_model1, mssdneg3_model3)
```
```{r}
mssdneg3_model4 <- lmer(negative_SD ~ 1 + instance + event + (1|id), data=withinday)
anova(mssdneg3_model1, mssdneg3_model4)
```
```{r}
mssdneg3_model5 <- lmer(negative_SD ~ 1 + instance + event*enrollmentgroup + (1|id), data=withinday)
anova(mssdneg3_model1, mssdneg3_model5)
```
```{r}
summary(mssdneg3_model5)
```
...
```{r}
#ASD Positive
mssdpos4_model1 <- lmer(positive_ASD ~ 1 + instance + (1|id), data=withinday)
anova(mssdpos4_nullmodel, mssdpos4_model1)
```
```{r}
#ASD Positive
mssdpos4_model2 <- lmer(positive_ASD ~ 1 + instance + day + (1|id), data=withinday)
anova(mssdpos4_model1, mssdpos4_model2)
```
```{r}
#ASD Positive
mssdpos4_model3 <- lmer(positive_ASD ~ 1 + instance + weekend + (1|id), data=withinday)
anova(mssdpos4_model1, mssdpos4_model3)
```
```{r}
#ASD Positive
mssdpos4_model4 <- lmer(positive_ASD ~ 1 + instance + weekend + event + (1|id), data=withinday)
anova(mssdpos4_model3, mssdpos4_model4)
```
```{r}
#ASD Positive
mssdpos4_model5 <- lmer(positive_ASD ~ 1 + instance + weekend + event*enrollmentgroup + (1|id), data=withinday)
anova(mssdpos4_model3, mssdpos4_model5)
```
```{r}
#ASD Positive
summary(mssdpos4_model5)
```
...
```{r}
#ASD Negative
mssdneg4_model1 <- lmer(negative_ASD ~ 1 + instance + (1|id), data=withinday)
anova(mssdneg4_nullmodel, mssdneg4_model1)
```
```{r}
#ASD Negative
mssdneg4_model2 <- lmer(negative_ASD ~ 1 + instance + day + (1|id), data=withinday)
anova(mssdneg4_nullmodel, mssdneg4_model2)
```
```{r}
#ASD Negative
mssdneg4_model3 <- lmer(negative_ASD ~ 1 + instance + weekend + (1|id), data=withinday)
anova(mssdneg4_model1, mssdneg4_model3)
```
```{r}
#ASD Negative
mssdneg4_model4 <- lmer(negative_ASD ~ 1 + instance + event + (1|id), data=withinday)
anova(mssdneg4_model1, mssdneg4_model4)
```
```{r}
#ASD Negative
mssdneg4_model5 <- lmer(negative_ASD ~ 1 + instance + event*enrollmentgroup + (1|id), data=withinday)
anova(mssdneg4_model1, mssdneg4_model5)
```
```{r}
summary(mssdneg4_model5)
```
